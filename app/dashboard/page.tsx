  ...
  return (
    <div className="min-h-screen bg-bg px-6 py-10">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-semibold text-text">My Cards</h1>
          <p className="text-text-2 mt-1">Every WishCard you've sent, in one place.</p>
        </div>
        ...
        >
          <Plus className="w-4 h-4" /> Create a new card
        </Link>

        {cards === null ? null : cards.length === 0 ? (
          <p className="text-center text-text-3 py-12">You haven't sent a WishCard yet.</p>
        ) : (
